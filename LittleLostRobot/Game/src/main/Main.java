...
public class Main
{
    public static void main(String[] args)  
    {
        ...
        GamePanel gamePanel = new GamePanel(); // "Import" our GamePanel class through a "gamePanel" variable
        window.add(gamePanel); // "Activates/Adds" our gamePanel class/variable
